...
import com.izhharuddinarief.tugasakhir.parser.MarkerJSONParser;
...
public class PetaWisata extends AppCompatActivity implements
        LocationListener,
        OnMapReadyCallback,
        ...
        if (cek_internet(this))
        {
            ...
            dialog.setPositiveButton("Ok", new OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    PetaWisata.this.startActivity(new Intent(Settings.ACTION_SETTINGS));
                    dialog.cancel();
                }
            }).show();
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
      ...
      //  center = new LatLng(-6.9941392, 108.9852259);
        center = new LatLng(-7.0749278,108.9314385);
    ...
    public void onResult(@NonNull LocationSettingsResult locationSettingsResult) {
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    status.startResolutionForResult(PetaWisata.this, REQUEST_CHECK_SETTINGS);
    ...
    private class AmbilData extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            String strUrl = serverlink.url_wisata_json;
            URL url;
